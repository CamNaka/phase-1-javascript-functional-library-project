...
function myMap(collection, callback) {  //breakdown of how .map() works
  let modifiedArr = []
...
function myReduce(collection, callback, acc) {  //breakdown of how .reduce() works
...
function myFind(collection, callback) { //breakdown of how .find() works
  for(let ele in collection) {
...
function myFilter(collection, callback) { //breakdown of how .filter() works
  let selectedArray = [];
